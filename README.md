# 5-17 Introduction to JavaScript
...
[Arrow Function Repl.it](https://replit.com/@jenn_leigh_hansen/arrowFunctions#index.js)
[Repl.it from Lecture](https://replit.com/@jenn_leigh_hansen/SpringgreenDisastrousPetabyte#index.js)